...
namespace POCConsole
{
    class Program
    {
        ...
        {
            TestThreadPool();
            //TestLimitTaskScheduler();


            Console.ReadKey();
        }

        //https://dotblogs.com.tw/code6421/2015/06/16/151579
        //https://blog.miniasp.com/post/2009/04/10/The-thread-pool-worker-threads-per-available-processor
